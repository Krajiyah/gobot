...
[![GoDoc](https://godoc.org/github.com/Krajiyah/gobot?status.svg)](https://godoc.org/github.com/Krajiyah/gobot)
...
Get the Gobot package by running this command: `go get -d -u github.com/Krajiyah/gobot`
...
To activate the API, import the `github.com/Krajiyah/gobot/api` package and instantiate the `API` like this:
