...
This package provides drivers for [i2c](https://en.wikipedia.org/wiki/I%C2%B2C)devices. It must be used along with an adaptor such as [firmata](https://github.com/Krajiyah/gobot/platforms/firmata) that supports the needed interfaces for i2c devices.
